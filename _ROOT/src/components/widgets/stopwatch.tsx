/* Opgave: Byg et stopur
Opgaven er en øvelse i at lære at forstå og bruge Reacts useEffect-hook. 
Opgavekrav:
FÆRDIG - Du skal anvende useEffect hooks til at styre urets adfærd.
FÆRDIG - Man skal kunne styre uret via en start og stop knap. Trykker man på start går uret i gang og omvendt når man trykker på stop.
FÆRDIG - Det skal være muligt at nulstille uret så man kan starte den forfra igen. 
FÆRDIG: Design og styling er helt op til dig. 
*/
