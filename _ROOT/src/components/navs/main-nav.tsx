    ...
    return (
        <nav className={navstyling.mainNavByMariePierreLessard}>
            <ul>
                ...
                <li>
                    {/* Old version (from previous assignment): 
                    <a href="#cardsWithHbf">My cards with props</a>
                    */}
                    <NavLink 
                        to="/cards-with-hbf" 
                        onClick={() => setter("My Cards with Props")}
                        className={({ isActive }) => (isActive ? `${navstyling.activeNavLinkByMariePierreLessard}` : "")}
                    >
                        My Cards with Props
                    </NavLink>
                ...
                <li>
                    {/* Old version (from previous assignment): 
                    <a href="#stopwatch">My stopwatch</a>
                     */}
                    <NavLink 
                        to="/stopwatch" 
                        onClick={() => setter("My Stopwatch")}
                        className={({ isActive }) => (isActive ? `${navstyling.activeNavLinkByMariePierreLessard}` : "")}
                    >
                        My Stopwatch
                    </NavLink>
                ...
                <li>
                    {/* Old version (from previous assignment): 
                    <a href="#globalFooter">Copyright </a>
                    */}
